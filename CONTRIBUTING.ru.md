...
- `src/YandexMusic.Quasar` — Quasar: умные колонки в локальной сети (отдельный пакет).
...
3. Опишите изменения в PR и добавьте запись в `CHANGELOG.md` и `CHANGELOG.ru.md` (раздел `Unreleased`).
